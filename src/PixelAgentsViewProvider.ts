...
import { AGENT_PROVIDERS, AGENT_PROVIDER_IDS, isAgentProviderId } from './providers.js';
		...
		webviewView.webview.onDidReceiveMessage(async (message) => {
			if (message.type === 'openAgent') {
				...
				await launchNewTerminal(
					...
					this.agents, this.activeAgentId, this.knownJsonlFiles, this.claimedJsonlFiles, this.claimedCodexSessions,
				...
				restoreAgents(
					this.context,
					this.nextAgentId, this.nextTerminalIndex,
					this.agents, this.knownJsonlFiles, this.claimedJsonlFiles, this.claimedCodexSessions,
					this.fileWatchers, this.pollingTimers, this.waitingTimers, this.permissionTimers,
		...
		vscode.window.onDidCloseTerminal((closed) => {
			for (const [id, agent] of this.agents) {
				if (agent.terminalRef === closed) {
					...
					removeAgent(
						id, this.agents, this.claimedJsonlFiles, this.claimedCodexSessions,
						this.fileWatchers, this.pollingTimers, this.waitingTimers, this.permissionTimers,
