...
export const COPILOT_TURN_IDLE_DELAY_MS = 1500;
export const CODEX_SESSION_META_READ_MAX_BYTES = 256 * 1024;
export const COPILOT_NARRATION_TOOL_ID = '__copilot_narration__';
