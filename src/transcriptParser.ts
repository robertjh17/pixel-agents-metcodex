...
export function processTranscriptLine(
	...
	try {
		...
		if (record.type === 'assistant' && Array.isArray(record.message?.content)) {
			...
			const copilotEffects = processCopilotEvent(agentId, record, agent, agents, waitingTimers, permissionTimers, webview);
			effects.clearPermission = copilotEffects.clearPermission;
		}
	} catch {
